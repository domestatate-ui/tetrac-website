...
export default function CTASection() {
  ...
  return (
    <section id="cta" ref={ref} className="relative py-24 border-t border-white/[0.05]">
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              className="flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-500 text-white font-semibold text-base shadow-2xl shadow-indigo-500/30 transition-all duration-300"
            >
              Get Early Access
              <ArrowRight size={16} />
            </motion.a>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="flex items-center gap-2.5 px-8 py-4 rounded-xl border border-white/[0.12] bg-white/[0.04] text-white font-semibold text-base hover:bg-white/[0.08] transition-all duration-200"
            >
